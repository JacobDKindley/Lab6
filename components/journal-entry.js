...
class JournalEntry extends HTMLElement {
  ...
  set entry(entry) {
    ...
    const ar=this.shadowRoot.querySelector('article');
    ar.children[0].innerHTML=(entry.title);
    ar.children[1].innerHTML=(entry.date);
    ar.children[2].innerHTML=(entry.content);
